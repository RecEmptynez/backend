...
def search_recipe(search:Search,db:Session):
    ...
    return SearchResult(recipe_names={recipe[0]: {"owned":recipe[6],"total":get_num_ingredients(recipe[1],db),"url":recipe[2], "picture_url":recipe[3], "rating":recipe[4]} for recipe in result})